            ...
            <Box padding="0 10px">
                ...
                display={{base:"flex",xl:"none"}}>
                    <Menu className="flex items-center">
                        ...
                        <MenuButton
                                className={`text-uppercase flex items-center ${isActive('/Arcade') ? 'active-menu' : ''}`}
                                as={NavLink} style={TextStyle}
                                to="/Arcade" 
                           >
                            <TbBrandAppleArcade  style={IconStyle} />
                            {t(`Arcade`)}
                        </MenuButton>
                        <MenuButton
                                 className={`text-bas text-uppercase flex items-center ${isActive('/Lottery') ? 'active-menu' : ''}`}
                                 as={NavLink} style={TextStyle}
                                 to="/Lottery" 
                            >
                            <TbBrandAppleArcade  style={IconStyle} />
